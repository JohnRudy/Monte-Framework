...
namespace Monte.Lib
{
    ...
    {
        public static Vector2 ClosestDirectionFromCircleToRectangle(SDL_Point circleCenter, float radius, SDL_Rect rectangle)
        {
        ...
        public static Vector2 FindRepresentativeDirection(List<Polygon> polygonsA, List<Polygon> polygonsB)
        {
            ...
            SDL_Point pointA = polygonsA.First().Vertices.First();
            SDL_Point pointB = polygonsB.First().Vertices.First();
