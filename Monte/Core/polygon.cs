...
namespace Monte.Lib
{
    ...
    public struct Edge
    {
        ...
        public static List<Edge> EdgesFromPoints(List<SDL_Point> points)
        {
    ...
    {
        public List<SDL_Point> Vertices;

        public Polygon(List<SDL_Point> Vertices)
        {
            if (Vertices.Count < 3)
        ...
        public static List<Polygon> SimpleTriangulateConvex(List<SDL_Point> Vertices)
        {
            if (Vertices.Count < 3)
        ...
        public SDL_Point PolygonCenter()
        {
            HashSet<SDL_Point> uniquePoints = new();
        ...
        {
            List<SDL_Point> newVerts = new();
            foreach (var p in Vertices)
            {
                newVerts.Add(new SDL_Point() { x = p.x + by.x, y = p.y + by.y });
            }
